...
export default class App extends React.Component {
  constructor(props) {
    ...
    this.toggleValidateInputOnChange = this.toggleValidateInputOnChange.bind(this);
  ...
  componentWillReceiveProps({loading, children}) {
    ...
    if (!loading && !children) {
      ...
      if (list) {
        // ja ES6 ${} injects the variable in curly brackests in the `…`-string
  ...
  toggleValidateInputOnChange(validateInputOnChange = !Session.get('validateInputOnChange')) {
    Session.set({validateInputOnChange});
  }
...
logout() {
    ...
    // ja here we have to go back to some form of landing page / login screen
